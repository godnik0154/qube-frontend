    ...
    <>
      <div className="login-page">
        ...
        <div className="container login-container">
          <h1 className="login-cont-heading">Join as a creator</h1>
          <h6 className="login-cont-small-heading">
            Create your website, communicate with your fans and sell your
            offerings - all under your brand
          </h6>
          ...
          <div className="login-submit-area">
            <button disabled={(errors.email && errors.password)} style={errors.email && errors.password?{cursor:"not-allowed"}:{cursor:"pointer"}} onClick={handleClick} className="login-submit-btn">Continue with email</button>
